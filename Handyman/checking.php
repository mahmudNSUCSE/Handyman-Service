...
if (isset($_REQUEST['handyman'])) {
	if($_REQUEST['handyman'] == "logastchr"){
		$error = "You are Logged as a Handyman. Only a Customer can post!";
	}else{
		header('location: logout.php');
	}
}else{
...
<div>
	<div>
		...
		<div class="topnav">
			...
			<a href="search.php">Search Handyman</a>
			<?php 
