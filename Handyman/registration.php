			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >1 ) {
						...
						";
						//if (@mail($_POST['email'],"eBuyBD Activation Code",$msg, "From:eBuyBD <no-reply@handymanbd.xyz>")) {
			...
			<?php
				...
				if(isset($success_message)) {echo $success_message;}
				    ...
				    <div class="accounttype">
				      <input type="radio" value="Handyman" id="radioOne" name="account" checked/>
				      <label for="radioOne" class="radio" chec>As a Handyman</label>
				      <input type="radio" value="Customer" id="radioTwo" name="account" />
				      <label for="radioTwo" class="radio">As a Customer</label>
				    </div>
				  <hr>
