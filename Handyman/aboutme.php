...
if (isset($_REQUEST['uid'])) {
	...
	$rslttution = $con->query("SELECT * FROM applied_post WHERE (post_by='$user2' AND applied_by='$user' AND job_cf='1') OR applied_by='$user2' AND applied_to='$user'");
				...
				<?php
				 ...
				 ?>
					...
					<?php
						...
						$query2 = $con->query("SELECT * FROM handyman WHERE t_id='$user2' ORDER BY id DESC");
						$handyman_info = $query2->fetch_assoc();
						$umedium_db = $handyman_info['medium'];
						$usalrange_db = $handyman_info['salary'];
						$uclass_db = $handyman_info['class'];
						$uprejob_db = $handyman_info['prefer_job'];
						$upreloca_db = $handyman_info['prefer_location'];
						...
						<div class="p_body">';
							if($user == $user2){
								echo '<div>
								<a href="updatejobinfo.php?uid='.$user.'" style="float: right; color: #aaa; font-weight: bold;"><img src="image/edit.png" height="25" width="25" ></a>
							</div>';
							}
